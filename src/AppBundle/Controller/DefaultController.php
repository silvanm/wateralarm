...
class DefaultController extends Controller
{
    ...
    public function statusAction(Request $request)
    {
        ...
        if ($status->getWaterlevel() != $waterlevel) {
            $statusupdate->setIsStatuschange(true);
            mail(
                "silvan@muehlemann.com",
                "Wateralarm Status Change: ".$waterlevel,
                "Waterlevel: $waterlevel\r\nMuted: ".$request->query->get('muted')
            );
        } else {
            $statusupdate->setIsStatuschange(false);
        }
